...
DBT_AllPersistentOptions = {
	["Default"] = {
		["DBM"] = {
			...
			["EndColorAER"] = 1,
			["StartColorIB"] = 1,
			["Font"] = "Interface\\Addons\\RobotoFonts\\fonts\\Roboto-Black.ttf",
			...
			["HugeTimerY"] = -129.166564941406,
			["HugeTimerX"] = 12.4999475479126,
			["EndColorDB"] = 1,
			["StartColorAB"] = 1,
